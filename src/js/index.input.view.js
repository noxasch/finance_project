...
function hideAccountFrom() {
  document.getElementById(accountFrom).parentElement.parentElement.classList.add('hide');
  document.getElementById(accountFrom).setAttribute('disabled', true);
}

function showAccountFrom() {
  document.getElementById(accountFrom).parentElement.parentElement.classList.remove('hide');
  document.getElementById(accountFrom).removeAttribute('disabled');
}
